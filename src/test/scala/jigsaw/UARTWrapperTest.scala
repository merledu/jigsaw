...
// class UARTWrapperTest extends FreeSpec with ChiselScalatestTester {

//   "UART wrapper TEST" in {
//     implicit val config = WishboneConfig(32,32)
//     test(new UARTWrapper()).withAnnotations(Seq(VerilatorBackendAnnotation)) { c =>    
